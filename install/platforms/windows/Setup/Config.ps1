...
$script:CX_MSVC_VC = $CX_MSVC+"\VC"
$script:CX_MSVC_CL_X86 = $CX_MSVC_VC+"\bin\cl.exe"
$script:CX_MSVC_CL_X64 = $CX_MSVC_VC+"\bin\amd64\cl.exe"
$script:CX_MSVC_CL_X86_AMD64 = $CX_MSVC_VC+"\bin\x86_amd64\cl.exe"
$script:CX_MSVC_VCVARSALL = $CX_MSVC_VC+"\vcvarsall.bat"
