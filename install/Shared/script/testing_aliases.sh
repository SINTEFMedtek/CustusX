...
alias appleint="~/dev/working/CustusX3/CustusX3/install/Shared/script/cxRunTests.py --run_catch [integration]~[unstable]~[hide]~[not_apple]"
...
alias int="~/dev/working/CustusX3/CustusX3/install/Shared/script/cxRunTests.py --run_catch [integration]~[unstable]~[hide]~[not_linux]"
