                     ...
                     plane_eq* bscan_plane_equations)
{
  ...
  cl_mem dev_bscans1 = ocl_create_buffer(context->context, CL_MEM_READ_ONLY, bscans_size/2, bscans + bscans_size/2);
  ...
  for (int section = 0; section < 1; section++) {
    ...
    global_work_size[0] = (volume_w*volume_n/1/256+1)*256;
