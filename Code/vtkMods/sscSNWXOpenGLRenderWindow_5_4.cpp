...
class SNWXOpenGLRenderWindow;
class vtkRenderWindow;
class vtkXOpenGLRenderWindowInternal
{
  friend class SNWXOpenGLRenderWindow;
private:
...
XVisualInfo *SNWXOpenGLRenderWindow::GetDesiredVisualInfo()
{
  XVisualInfo   *v = NULL;
  int           alpha;
  int           multi;
...
void SNWXOpenGLRenderWindow::Frame()
{
  this->MakeCurrent();
...
//
void SNWXOpenGLRenderWindow::SetStereoCapableWindow(int capable)
{
...
void SNWXOpenGLRenderWindow::CreateAWindow()
{
...
void SNWXOpenGLRenderWindow::DestroyWindow()
{
  // free the cursors
  if (this->DisplayId)
    {
...
void SNWXOpenGLRenderWindow::CreateOffScreenWindow(int width, int height)
{
...
void SNWXOpenGLRenderWindow::DestroyOffScreenWindow()
{
...
void SNWXOpenGLRenderWindow::ResizeOffScreenWindow(int width, int height)
{
...
void SNWXOpenGLRenderWindow::WindowInitialize (void)
{
  this->CreateAWindow();
...
void SNWXOpenGLRenderWindow::Initialize (void)
{
...
void SNWXOpenGLRenderWindow::Finalize (void)
{
...
void SNWXOpenGLRenderWindow::SetFullScreen(int arg)
{
  int *temp;
...
void SNWXOpenGLRenderWindow::PrefFullScreen()
{
  // use full screen
  this->Position[0] = 0;
  this->Position[1] = 0;
...
// Resize the window.
void SNWXOpenGLRenderWindow::WindowRemap()
{
...
void SNWXOpenGLRenderWindow::Start(void)
{
  this->Initialize();
...
void SNWXOpenGLRenderWindow::SetSize(int width,int height)
{
...
int SNWXOpenGLRenderWindow::GetDesiredDepth()
{
  XVisualInfo *v;
  int depth = 0;
...
Visual *SNWXOpenGLRenderWindow::GetDesiredVisual ()
{
  XVisualInfo *v;
  Visual *vis=0;
...
Colormap SNWXOpenGLRenderWindow::GetDesiredColormap ()
{
  XVisualInfo *v;
...
void SNWXOpenGLRenderWindow::PrintSelf(ostream& os, vtkIndent indent)
{
...
void SNWXOpenGLRenderWindow::MakeCurrent()
{
...
bool SNWXOpenGLRenderWindow::IsCurrent()
{
  bool result=false;
#ifdef VTK_OPENGL_HAS_OSMESA
  if(this->OffScreenRendering && this->Internal->OffScreenContextId)
...
void SNWXOpenGLRenderWindow::SetForceMakeCurrent()
{
...
void *SNWXOpenGLRenderWindow::GetGenericContext()
{
...
int SNWXOpenGLRenderWindow::GetEventPending()
{
  XEvent report;
...
int *SNWXOpenGLRenderWindow::GetScreenSize()
{
  // get the default display connection
  if (!this->DisplayId)
    {
...
int *SNWXOpenGLRenderWindow::GetPosition(void)
{
  XWindowAttributes attribs;
  int x,y;
  Window child;
...
Display *SNWXOpenGLRenderWindow::GetDisplayId()
{
...
Window SNWXOpenGLRenderWindow::GetParentId()
{
...
Window SNWXOpenGLRenderWindow::GetWindowId()
{
...
void SNWXOpenGLRenderWindow::SetPosition(int x, int y)
{
...
void SNWXOpenGLRenderWindow::SetParentId(Window arg)
{
//   if (this->ParentId)
//     {
...
void SNWXOpenGLRenderWindow::SetWindowId(Window arg)
{
...
// Set this RenderWindow's X window id to a pre-existing window.
void SNWXOpenGLRenderWindow::SetWindowInfo(char *info)
{
  int tmp;
...
// Set this RenderWindow's X window id to a pre-existing window.
void SNWXOpenGLRenderWindow::SetNextWindowInfo(char *info)
{
  int tmp;
  sscanf(info,"%i",&tmp);
...
void SNWXOpenGLRenderWindow::SetParentInfo(char *info)
{
  int tmp;
...
void SNWXOpenGLRenderWindow::SetWindowId(void *arg)
{
  this->SetWindowId(reinterpret_cast<Window>(arg));
}
void SNWXOpenGLRenderWindow::SetParentId(void *arg)
{
  this->SetParentId(reinterpret_cast<Window>(arg));
}

const char* SNWXOpenGLRenderWindow::ReportCapabilities()
{
  MakeCurrent();
...
int SNWXOpenGLRenderWindow::SupportsOpenGL()
{
  this->MakeCurrent();
  if (!this->DisplayId)
    {
...
int SNWXOpenGLRenderWindow::IsDirect()
{
  this->MakeCurrent();
  this->UsingHardware = 0;
  if (this->OffScreenRendering && this->Internal->PbufferContextId)
...
void SNWXOpenGLRenderWindow::SetWindowName(const char * cname)
{
...
void SNWXOpenGLRenderWindow::SetNextWindowId(Window arg)
{
...
void SNWXOpenGLRenderWindow::SetNextWindowId(void *arg)
{
...
// X display id.
void SNWXOpenGLRenderWindow::SetDisplayId(Display  *arg)
{
...
void SNWXOpenGLRenderWindow::SetDisplayId(void *arg)
{
  this->SetDisplayId(static_cast<Display *>(arg));
  this->OwnDisplay = 0;
}

void SNWXOpenGLRenderWindow::Render()
{
  XWindowAttributes attribs;
...
//----------------------------------------------------------------------------
void SNWXOpenGLRenderWindow::HideCursor()
{
...
//----------------------------------------------------------------------------
void SNWXOpenGLRenderWindow::ShowCursor()
{
  if (!this->DisplayId || !this->WindowId)
    {
    this->CursorHidden = 0;
...
//============================================================================
// Stuff above this is almost a mirror of SNWXOpenGLRenderWindow.
...
// (mangled) from SNWXOpenGLRenderWindow like the other OpenGL classes.
//============================================================================

void SNWXOpenGLRenderWindow::SetOffScreenRendering(int i)
{
...
void *SNWXOpenGLRenderWindow::GetGenericWindowId()
{
#ifdef VTK_OPENGL_HAS_OSMESA
...
void SNWXOpenGLRenderWindow::SetCurrentCursor(int shape)
{
