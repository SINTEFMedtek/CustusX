...
1. Get a data set in metaheader (mhd) format. You can use the Kaisa data set for a start. 
   (available along with the installation, or at https://gitlab.sintef.no/custusx/CustusXData/-/tree/master/Phantoms/Kaisa/MetaImage?ref_type=heads). See also \ref import_overview
2. Start CustusX
