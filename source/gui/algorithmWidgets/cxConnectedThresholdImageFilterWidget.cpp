...
ConnectedThresholdImageFilterWidget::ConnectedThresholdImageFilterWidget(QWidget* parent) /*<1>:
    WhatsThisWidget(parent, "ConnectedThresholdImageFilterWidget", "Connected Threshold Image Filter")*//*<7>,
