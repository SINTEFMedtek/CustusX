...
ToolTipCalibrationWidget::ToolTipCalibrationWidget(QWidget* parent) :
  cxBaseWidget(parent, "ToolTipCalibrationWidget", "Tool Tip Calibration"),
...
ToolTipCalibrateWidget::ToolTipCalibrateWidget(QWidget* parent) :
    cxBaseWidget(parent, "ToolTipCalibrateWidget", "ToolTip Calibrate"),
...
ToolTipSampleWidget::ToolTipSampleWidget(QWidget* parent) :
    cxBaseWidget(parent, "ToolTipSampleWidget", "ToolTip Sample"),
