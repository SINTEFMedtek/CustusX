...
*/
vtkPolyDataPtr AirwaysFromCenterline::generateTubes(double radius)
{
    vtkImageDataPtr airwaysVolumePtr = this->initializeAirwaysVolume();

    airwaysVolumePtr = addSpheresAlongCenterlines(airwaysVolumePtr, radius);
...
vtkImageDataPtr AirwaysFromCenterline::addSpheresAlongCenterlines(vtkImageDataPtr airwaysVolumePtr, double radius)
{
    std::vector<BranchPtr> branches = mBranchListPtr->getBranches();
