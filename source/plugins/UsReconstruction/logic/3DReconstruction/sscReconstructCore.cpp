 ...
 */
void ReconstructCore::calibrateTimeStamps(double offset, double scale)
{
 ...
 */
void ReconstructCore::alignTimeSeries()
{
 ...
 */
void ReconstructCore::cropInputData()
{
	//IntBoundingBox3D
 ...
 *
 */
void ReconstructCore::applyTimeCalibration()
{
 ...
 */
Transform3D ReconstructCore::interpolate(const Transform3D& a, const Transform3D& b, double t)
{
	Transform3D c;
	for (int i = 0; i < 4; i++)
		for (int j = 0; j < 4; j++)
 ...
 */
Transform3D ReconstructCore::slerpInterpolate(const Transform3D& a, const Transform3D& b, double t)
{
 ...
 * Post: mPos is prMu
 */
void ReconstructCore::transformPositionsTo_prMu()
{
 ...
 */
std::vector<ssc::Vector3D> ReconstructCore::generateInputRectangle()
{
 ...
 *       mExtent is defined
 */
void ReconstructCore::findExtentAndOutputTransform()
{
 ...
 */
void ReconstructCore::updateFromOriginalFileData()
{
...
void ReconstructCore::initialize(InputParams input, USReconstructInputData fileData)
{
	mInput = input;
