...
TEST_CASE("ElastiX should register kaisa to a translated+resampled version of same", "[pluginRegistration][integration]")
{
	...
	cx::DataPtr kaisa_resliced_linear = cx::dataManager()->loadData("source_"+kaisa_resliced_linear_fname, kaisa_resliced_linear_fname, cx::rtAUTO);
	cx::DataPtr kaisa_padded = cx::dataManager()->loadData("source_"+kaisa_padded_fname, kaisa_padded_fname, cx::rtAUTO);
	cx::DataPtr kaisa_resliced = cx::dataManager()->loadData("source_"+kaisa_resliced_fname, kaisa_resliced_fname, cx::rtAUTO);
