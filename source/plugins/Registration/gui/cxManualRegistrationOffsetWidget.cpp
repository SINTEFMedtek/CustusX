...
namespace cx
{
ManualRegistrationOffsetWidget::ManualRegistrationOffsetWidget(RegistrationManagerPtr regManager, QWidget* parent) :
    RegistrationBaseWidget(regManager, parent, "ManualRegistrationOffsetWidget", "Manual Registration Offset"),
...
void ManualRegistrationOffsetWidget::setOffsetSlot(int value)
{
  ...
  mManager->setManualPatientRegistrationOffsetSlot(offset);
}
