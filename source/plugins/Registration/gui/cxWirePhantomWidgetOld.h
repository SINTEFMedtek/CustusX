...
#ifndef CXWirePhantomWidgetOld_H_
#define CXWirePhantomWidgetOld_H_
 ...
 *  \author christiana
 */
class WirePhantomWidgetOld: public RegistrationBaseWidget
{
Q_OBJECT

public:
    WirePhantomWidgetOld(RegistrationManagerPtr regManager, QWidget* parent);
    virtual ~WirePhantomWidgetOld();
...
#endif /* CXWirePhantomWidgetOld_H_ */
