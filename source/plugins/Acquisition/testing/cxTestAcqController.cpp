...
//	int framesPerSecond = 20; // minimum frame rate
	...
	CPPUNIT_ASSERT(ssc::similar(frame_time_ms, mRecordDuration, 0.3*mRecordDuration));
	...
	CPPUNIT_ASSERT(ssc::similar(pos_time_ms, mRecordDuration, 0.1*mRecordDuration));
