...
[Elastix](https://elastix.lumc.nl/) is normally used for the registration as an external application, although any program with the same input/output can be used.
