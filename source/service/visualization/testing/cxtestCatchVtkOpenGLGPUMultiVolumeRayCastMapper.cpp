...
void testVtkOpenGLGPUMultiVolumeRayCastMapper(std::vector<cx::ImagePtr> images)
{
...
TEST_CASE("vtkOpenGLGPUMultiVolumeRayCastMapper can render 3 small volumes", "[unit][gui]")
{
...
TEST_CASE("vtkOpenGLGPUMultiVolumeRayCastMapper can render 1 small volume", "[unit][gui]")
{
