...
TEST_CASE("ImageEnveloper: Two nonoverlapping images", "[unit][resource][visualization][hide]")
{
	unsigned int size = 5;
	int shift = 10;
...
TEST_CASE("ImageEnveloper: Two overlapping images", "[unit][resource][visualization][hide]")
{
	unsigned int size = 5;
	int shift = 2;
	std::vector<cx::ImagePtr> images = cxtest::Utilities::create3DImages(2, Eigen::Array3i(size,size,size), 200);
...
TEST_CASE("ImageEnveloper: One image inside another", "[unit][resource][visualization][hide]")
{
	unsigned int size = 5;
...
TEST_CASE("ImageEnveloper: One high-res image inside another", "[unit][resource][visualization][hide]")
{
	unsigned int size = 5;
	std::vector<cx::ImagePtr> images;
	images.push_back(cxtest::Utilities::create3DImage(Eigen::Array3i(size,size,size), 200));
