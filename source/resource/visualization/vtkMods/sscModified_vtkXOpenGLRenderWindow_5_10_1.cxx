/*=========================================================================
  ...
  Module:    sscModified_vtkXOpenGLRenderWindow.cxx
...
{
  friend class sscModified_vtkXOpenGLRenderWindow;
private:
  sscModified_vtkXOpenGLRenderWindowInternal(vtkRenderWindow*);
...
sscModified_vtkXOpenGLRenderWindowInternal::sscModified_vtkXOpenGLRenderWindowInternal(
  vtkRenderWindow *rw)
{
  this->ContextId = NULL;
...
#ifndef VTK_IMPLEMENT_MESA_CXX
vtkStandardNewMacro(sscModified_vtkXOpenGLRenderWindow);
#endif
...
vtkglX::GLXFBConfig* sscModified_vtkXOpenGLRenderWindowTryForFBConfig(Display *DisplayId,
                                                          int drawable_type,
                                                          int doublebuff,
                                                          int stereo,
                                                          int multisamples,
...
XVisualInfo *sscModified_vtkXOpenGLRenderWindowTryForVisual(Display *DisplayId,
...
#ifndef VTK_IMPLEMENT_MESA_CXX
vtkglX::GLXFBConfig *sscModified_vtkXOpenGLRenderWindowGetDesiredFBConfig(
  Display *DisplayId,
  int &win_stereo,
  ...
  int &stencil)
{
  ...
  for (stereo = win_stereo; !fbc && stereo >= 0; stereo--)
    ...
    for (multi = win_multisamples; !fbc && multi >= 0; multi--)
      ...
      fbc = sscModified_vtkXOpenGLRenderWindowTryForFBConfig(DisplayId,
                                                 drawable_type,
                                                 win_doublebuffer,
                                                 stereo, multi,
                                                 win_alphaplanes,
...
XVisualInfo *sscModified_vtkXOpenGLRenderWindow::GetDesiredVisualInfo()
{
  XVisualInfo   *v = NULL;
  int           alpha;
  int           multi;
    ...
    for (alpha = this->AlphaBitPlanes; !v && alpha >= 0; alpha--)
      ...
      for (stereo = this->StereoCapableWindow; !v && stereo >= 0; stereo--)
        ...
        for (multi = this->MultiSamples; !v && multi >= 0; multi--)
          ...
          v = sscModified_vtkXOpenGLRenderWindowTryForVisual(this->DisplayId,
                                                 this->DoubleBuffer, 
                                                 stereo, multi, alpha, 
                                                 stencil);
          if (v)
...
sscModified_vtkXOpenGLRenderWindow::sscModified_vtkXOpenGLRenderWindow()
{
  ...
  this->Internal = new sscModified_vtkXOpenGLRenderWindowInternal(this);
...
void sscModified_vtkXOpenGLRenderWindow::Frame()
{
  this->MakeCurrent();
...
//
void sscModified_vtkXOpenGLRenderWindow::SetStereoCapableWindow(int capable)
{
...
void sscModified_vtkXOpenGLRenderWindow::CreateAWindow()
{
...
void sscModified_vtkXOpenGLRenderWindow::DestroyWindow()
{
  // free the cursors
  if (this->DisplayId)
    {
...
void sscModified_vtkXOpenGLRenderWindow::CreateOffScreenWindow(int width, int height)
{
...
//          int loaded = vtkgl::LoadExtension("GLX_VERSION_1_3", manager);
          ...
          if(loaded)
            {
            // get FBConfig
            vtkglX::GLXFBConfig* fb = sscModified_vtkXOpenGLRenderWindowGetDesiredFBConfig(
...
void sscModified_vtkXOpenGLRenderWindow::DestroyOffScreenWindow()
{
...
void sscModified_vtkXOpenGLRenderWindow::ResizeOffScreenWindow(int width, int height)
{
...
void sscModified_vtkXOpenGLRenderWindow::WindowInitialize (void)
{
  this->CreateAWindow();
...
void sscModified_vtkXOpenGLRenderWindow::Initialize (void)
{
...
void sscModified_vtkXOpenGLRenderWindow::Finalize (void)
{
...
void sscModified_vtkXOpenGLRenderWindow::SetFullScreen(int arg)
{
  int *temp;
...
void sscModified_vtkXOpenGLRenderWindow::PrefFullScreen()
{
  // use full screen 
  this->Position[0] = 0;
  this->Position[1] = 0;
...
// Resize the window.
void sscModified_vtkXOpenGLRenderWindow::WindowRemap()
{
...
void sscModified_vtkXOpenGLRenderWindow::Start(void)
{
  this->Initialize();
...
void sscModified_vtkXOpenGLRenderWindow::SetSize(int width,int height)
{
...
int sscModified_vtkXOpenGLRenderWindow::GetDesiredDepth()
{
  XVisualInfo *v;
  int depth = 0;
...
Visual *sscModified_vtkXOpenGLRenderWindow::GetDesiredVisual ()
{
  XVisualInfo *v;
  Visual *vis=0;
...
Colormap sscModified_vtkXOpenGLRenderWindow::GetDesiredColormap ()
{
  XVisualInfo *v;
...
void sscModified_vtkXOpenGLRenderWindow::PrintSelf(ostream& os, vtkIndent indent)
{
...
void sscModified_vtkXOpenGLRenderWindow::MakeCurrent()
{
...
bool sscModified_vtkXOpenGLRenderWindow::IsCurrent()
{
  bool result=false;
#ifdef VTK_OPENGL_HAS_OSMESA
  if(this->OffScreenRendering && this->Internal->OffScreenContextId)
...
void sscModified_vtkXOpenGLRenderWindow::SetForceMakeCurrent()
{
  this->ForceMakeCurrent = 1;
}

int sscModified_vtkXOpenGLRenderWindowFoundMatch;

extern "C"
{
  Bool sscModified_vtkXOpenGLRenderWindowPredProc(Display *vtkNotUsed(disp),
                                      XEvent *event, 
                                      char *arg)
  {
    ...
    if (((reinterpret_cast<XAnyEvent *>(event))->window == win) &&
      ...
      {
      sscModified_vtkXOpenGLRenderWindowFoundMatch = 1;
      }
...
void *sscModified_vtkXOpenGLRenderWindow::GetGenericContext()
{
...
int sscModified_vtkXOpenGLRenderWindow::GetEventPending()
{
  XEvent report;
  
  sscModified_vtkXOpenGLRenderWindowFoundMatch = 0;
  if (this->OffScreenRendering)
    {
    return sscModified_vtkXOpenGLRenderWindowFoundMatch;
    }
  XCheckIfEvent(this->DisplayId, &report, sscModified_vtkXOpenGLRenderWindowPredProc,
                reinterpret_cast<char *>(this->WindowId));
  return sscModified_vtkXOpenGLRenderWindowFoundMatch;
}

// Get the size of the screen in pixels
int *sscModified_vtkXOpenGLRenderWindow::GetScreenSize()
{
  // get the default display connection 
  if (!this->DisplayId)
    {
...
int *sscModified_vtkXOpenGLRenderWindow::GetPosition(void)
{
  XWindowAttributes attribs;
  int x,y;
  Window child;
...
Display *sscModified_vtkXOpenGLRenderWindow::GetDisplayId()
{
...
Window sscModified_vtkXOpenGLRenderWindow::GetParentId()
{
...
Window sscModified_vtkXOpenGLRenderWindow::GetWindowId()
{
...
void sscModified_vtkXOpenGLRenderWindow::SetPosition(int x, int y)
{
...
void sscModified_vtkXOpenGLRenderWindow::SetParentId(Window arg)
{
//   if (this->ParentId)
//     {
...
void sscModified_vtkXOpenGLRenderWindow::SetWindowId(Window arg)
{
...
// Set this RenderWindow's X window id to a pre-existing window.
void sscModified_vtkXOpenGLRenderWindow::SetWindowInfo(char *info)
{
  int tmp;
...
// Set this RenderWindow's X window id to a pre-existing window.
void sscModified_vtkXOpenGLRenderWindow::SetNextWindowInfo(char *info)
{
  int tmp;
  sscanf(info,"%i",&tmp);
...
void sscModified_vtkXOpenGLRenderWindow::SetParentInfo(char *info)
{
  int tmp;
...
void sscModified_vtkXOpenGLRenderWindow::SetWindowId(void *arg)
{
  this->SetWindowId(reinterpret_cast<Window>(arg));
}
void sscModified_vtkXOpenGLRenderWindow::SetParentId(void *arg)
{
  this->SetParentId(reinterpret_cast<Window>(arg));
}

const char* sscModified_vtkXOpenGLRenderWindow::ReportCapabilities()
{
  MakeCurrent();
...
int sscModified_vtkXOpenGLRenderWindow::SupportsOpenGL()
{
  this->MakeCurrent();
  if (!this->DisplayId) 
    {
...
int sscModified_vtkXOpenGLRenderWindow::IsDirect()
{
  this->MakeCurrent();
  this->UsingHardware = 0;
  if (this->OffScreenRendering && this->Internal->PbufferContextId)
...
void sscModified_vtkXOpenGLRenderWindow::SetWindowName(const char * cname)
{
...
void sscModified_vtkXOpenGLRenderWindow::SetNextWindowId(Window arg)
{
...
void sscModified_vtkXOpenGLRenderWindow::SetNextWindowId(void *arg)
{
...
// X display id.
void sscModified_vtkXOpenGLRenderWindow::SetDisplayId(Display  *arg)
{
...
void sscModified_vtkXOpenGLRenderWindow::SetDisplayId(void *arg)
{
  this->SetDisplayId(static_cast<Display *>(arg));
  this->OwnDisplay = 0;
}

void sscModified_vtkXOpenGLRenderWindow::Render()
{
  XWindowAttributes attribs;
...
//----------------------------------------------------------------------------
void sscModified_vtkXOpenGLRenderWindow::HideCursor()
{
...
//----------------------------------------------------------------------------
void sscModified_vtkXOpenGLRenderWindow::ShowCursor()
{
  if (!this->DisplayId || !this->WindowId)
    {
    this->CursorHidden = 0;
...
//============================================================================
// Stuff above this is almost a mirror of sscModified_vtkXOpenGLRenderWindow.
...
// (mangled) from sscModified_vtkXOpenGLRenderWindow like the other OpenGL classes.
//============================================================================

void sscModified_vtkXOpenGLRenderWindow::SetOffScreenRendering(int i)
{
...
void *sscModified_vtkXOpenGLRenderWindow::GetGenericWindowId()
{
#ifdef VTK_OPENGL_HAS_OSMESA
...
void sscModified_vtkXOpenGLRenderWindow::SetCurrentCursor(int shape)
{
