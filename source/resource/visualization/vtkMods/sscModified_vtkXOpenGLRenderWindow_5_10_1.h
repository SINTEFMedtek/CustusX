/*=========================================================================
  ...
  Module:    sscModified_vtkXOpenGLRenderWindow.h
...
=========================================================================*/
// .NAME sscModified_vtkXOpenGLRenderWindow - OpenGL rendering window
// .SECTION Description
// sscModified_vtkXOpenGLRenderWindow is a concrete implementation of the abstract class
...
#ifndef __sscModified_vtkXOpenGLRenderWindow_h
#define __sscModified_vtkXOpenGLRenderWindow_h
...
class VTK_RENDERING_EXPORT sscModified_vtkXOpenGLRenderWindow : public vtkOpenGLRenderWindow
{
public:
  static sscModified_vtkXOpenGLRenderWindow *New();
  vtkTypeMacro(sscModified_vtkXOpenGLRenderWindow,vtkOpenGLRenderWindow);
...
protected:
  sscModified_vtkXOpenGLRenderWindow();
  ~sscModified_vtkXOpenGLRenderWindow();

  sscModified_vtkXOpenGLRenderWindowInternal *Internal;
...
private:
  sscModified_vtkXOpenGLRenderWindow(const sscModified_vtkXOpenGLRenderWindow&);  // Not implemented.
  void operator=(const sscModified_vtkXOpenGLRenderWindow&);  // Not implemented.
};
