...
//		tsOPENIGTLINK,      ///< Tracking through OpenIGTLink
	...
	enum cxResource_EXPORT LUNG_STRUCTURES
	{
		...
		lsSMALL_ORGANS,
		lsPET_REGISTERED,
		lsPULMONARY_ARTERIES_VEINS, // Combined segmentation checkbox/timer key for the lsPULMONARY_ARTERIES+lsPULMONARY_VEINS pair above; not itself a button.
		lsCOUNT,
