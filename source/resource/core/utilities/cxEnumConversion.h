...
// This is a convenience file to include for enum conversion.

// For using enum conversions this file have to be included instead if cxEnumConverter.h Including cxDefinitionStrings.h will also work.
