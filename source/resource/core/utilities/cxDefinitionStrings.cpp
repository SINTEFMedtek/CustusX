...
SNW_DEFINE_ENUM_STRING_CONVERTERS_BEGIN(cx, IMAGE_MODALITY, modCOUNT)
{
	"UNKNOWN",
	"CT",
	"MR",
...
SNW_DEFINE_ENUM_STRING_CONVERTERS_END(cx, IMAGE_MODALITY, modCOUNT)

SNW_DEFINE_ENUM_STRING_CONVERTERS_BEGIN(cx, IMAGE_SUBTYPE, isCOUNT)
{
	"UNKNOWN",
	"",
	"T1",
...
SNW_DEFINE_ENUM_STRING_CONVERTERS_END(cx, IMAGE_SUBTYPE, isCOUNT)
