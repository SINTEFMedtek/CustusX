#ifndef _QT_2_FUNC_4_H_
#define _QT_2_FUNC_4_H_
...
public:
	...
	Qt2FuncSlot4(const FuncType& func) :
		func_(func)
	{
	}
...
template<typename SIGNATURE>
class Qt2Func4 : public QObject, public QtConnDefault
{
public:
	typedef boost::function<SIGNATURE> FuncType;
	typedef typename boost::function_traits<SIGNATURE>::arg1_type ParmType;

	Qt2Func4(QObject* qobject, int signalIdx, const FuncType& func,
		...
		func_(func)
	{
		...
		//
		slot_ = new Qt2FuncSlot4<SIGNATURE>(func);
