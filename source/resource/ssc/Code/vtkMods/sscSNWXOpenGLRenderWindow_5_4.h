#ifndef SSCSNWXOPENGLRENDERWINDOW_H_
#define SSCSNWXOPENGLRENDERWINDOW_H_
...
class SNWXOpenGLRenderWindow: public vtkOpenGLRenderWindow
{
public:
	static SNWXOpenGLRenderWindow *New();
	vtkTypeRevisionMacro(SNWXOpenGLRenderWindow ,vtkOpenGLRenderWindow);
...
private:
	SNWXOpenGLRenderWindow(const SNWXOpenGLRenderWindow&); // Not implemented.
	void operator=(const SNWXOpenGLRenderWindow&); // Not implemented.

};

#endif /* SSCSNWXOPENGLRENDERWINDOW_H_ */
